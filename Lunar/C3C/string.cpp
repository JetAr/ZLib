...
char* szodStr(int v,char* star)
{
    ...
    char s[12][8]= {"摩羯座","宝瓶座","双鱼座","白羊座","金牛座","双子座","巨蟹座","狮子座","处女座","天秤座","天蝎座","射手座"};
    strcpy(star,s[v%12]);
    return star;
}
...
char* gzStr(int v,char* ganzhi)
{
    ...
    char tiangan[10][4] = {"癸","甲","乙","丙","丁","戊","己","庚","辛","壬"};
    char dizhi[12][4] = {"亥","子","丑","寅","卯","辰","巳","午","未","申","酉","戌"};
...
char* zodStr(int v,char* sx)
{
    ...
    v%=12;
    char shengxiao[12][4] = {"猪","鼠","牛","虎","兔","龙","蛇","马","羊","猴","鸡","狗"};
...
char* lunMStr(int v,char* yueshu)
{
    ...
    int v0=abs(v);
    char str[10][4]= {"一","二","三","四","五","六","七","八","九","十"};
    char vstr[4];
...
char* lunDStr(int v,char* nongli)
{
    ...
    char str[15][4]= {"十","一","二","三","四","五","六","七","八","九","初","十","廿","三"};
    strcpy(nongli,str[(int)(floor(v/10)+10)]);
...
char* sStr(int v,char* jieqi)
{
    ...
    char str[24][6] = {"小寒","大寒","立春","雨水","惊蛰","春分","清明","谷雨","立夏","小满","芒种","夏至","小暑","大暑",
...
char* stars28Str(int n,char* instr)
{
    ...
    char s[28][4]= {"角","亢","氐","房","心","尾","箕","斗","牛","女","虚","危","室","壁","奎","娄","胃","昴","毕","觜","参","井","鬼","柳","星","张","翼","轸"};
    strcpy(instr,s[n]);
    return instr;
}
